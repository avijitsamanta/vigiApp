				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="#">Manage Crimes Type</a></li>
						</ul>
					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							<div class="portlet-title">
								<h4><i class="icon-globe"></i>Managed Crime Type</h4>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">
										<a class="btn mini green" href="<?php echo base_url();?>admin/crimes/addcrime">Add New <i class="icon-plus"></i></a>
									</div>
	...
	{	
		...
		if(cnf)
		{
			...
			$.post('<?php echo base_url();?>admin/crimes/deleteCrime',{ type_id : id,mode : 'single' },
				function(data)
				{
					$('#tablesec').html(data);
