					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							<div class="portlet-title">
								<h4><i class="icon-globe"></i>Managed Post</h4>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">
										<a class="btn mini green" href="<?php echo base_url();?>admin/post/get_reported_post">Show Reported Post</a>
									</div>
									<div class="btn-group">
										<a class="btn mini green" href="<?php echo base_url();?>admin/post/">Show all Post</a>
									</div>
                    				...
                    				?>
										<tr class="odd gradeX">
											...
											<div class="controls">
												...
												<?php if($val['is_reported'] == '1'){ ?> Yes <?php } else {?>
											...
											<td ><?php if($val['is_reported'] == '1'){ ?><a class="btn mini green" data-toggle="modal" href="#popup" onclick="details(<?php echo $val['post_id']?>)">	<i class="icon-info-sign"></i> View Details </a><?php } ?></td>
	...
	{	
		...
		if(cnf)
		{
			...
			$.post('<?php echo base_url();?>admin/post/delete_post',{ post_id : id,mode : 'single' },
				function(data)
				{
					$('#tablesec').html(data);
	...
	{
		//alert('ok');
		$.post('<?php echo base_url();?>admin/posts/poststatus',{ stat : stat , id : id });
	}

	function details(id)
	{
		//alert(id);
			$.post('<?php echo base_url();?>admin/post/detailsPost',{ id : id },
