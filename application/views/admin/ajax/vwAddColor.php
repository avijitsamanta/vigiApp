...
<button class="close" type="button" data-dismiss="modal"></button>
  <h3 id="myModalLabel1"> Add Color</h3>
</div>



<form name="frmdest" action="<?php echo base_url();?>admin/product/updateColor/add" method="post" style="margin:0; padding:0" enctype="multipart/form-data" onsubmit="return validateForm()">
...
<option value="<?php echo $val->product_category_id;?>"><?php echo $val->product_category;?></option>
   ...
   <div class="control-group">
	  ...
	  <div class="controls">
		 <input type="text" class="span6 m-wrap" name="color_code" id="colorcode" value="" style="width:500px" required/>
	  </div>
    ...
    <div class="control-group">
	  ...
	  <div class="controls">
		 <input type="text" class="span6 m-wrap" name="color_name" id="colorcode" value="" style="width:500px" required/>
	  </div>
	   <p id="color_error" style="color:red;"></p>
   </div>
...
<script type="text/javascript">
	function validateForm()
	{
		...
		if(color.length > 15)
		{
			$("#color_error").html("Please provide maximum 15 characters as size.");
			return false;
		}
		return true;
	}
