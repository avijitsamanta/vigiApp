...
<head>
	...
	<link href="<?php echo HTTP_ASSETS_PATH_ADMIN?>bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet" />
	...
	<link rel="stylesheet" type="text/css" href="<?php echo HTTP_ASSETS_PATH_ADMIN?>gritter/css/jquery.gritter.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo HTTP_ASSETS_PATH_ADMIN?>uniform/css/uniform.default.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo HTTP_ASSETS_PATH_ADMIN?>bootstrap-daterangepicker/daterangepicker.css" />
	<link href="<?php echo HTTP_ASSETS_PATH_ADMIN?>fullcalendar/fullcalendar/bootstrap-fullcalendar.css" rel="stylesheet" />
	<link href="<?php echo HTTP_ASSETS_PATH_ADMIN?>jqvmap/jqvmap/jqvmap.css" media="screen" rel="stylesheet" type="text/css" />
...
<body class="fixed-top">
					...
					<li class="dropdown" id="header_notification_bar">
						...
						<ul class="dropdown-menu extended notification">
							...
							<li>
								...
								New user registered. 
								<span class="time">Just now</span>								</a>							</li>
							<li>
								<a href="#">
								<span class="label label-important"><i class="icon-bolt"></i></span>
								Server #12 overloaded. 
								<span class="time">15 mins</span>								</a>							</li>
							<li>
								<a href="#">
								<span class="label label-warning"><i class="icon-bell"></i></span>
								Server #2 not respoding.
								<span class="time">22 mins</span>								</a>							</li>
							<li>
								<a href="#">
								<span class="label label-info"><i class="icon-bullhorn"></i></span>
								Application error.
								<span class="time">40 mins</span>								</a>							</li>
							<li>
								<a href="#">
								<span class="label label-important"><i class="icon-bolt"></i></span>
								Database overloaded 68%. 
								<span class="time">2 hrs</span>								</a>							</li>
							<li>
								<a href="#">
								<span class="label label-important"><i class="icon-bolt"></i></span>
								2 user IP blocked.
							...
							<li class="external">
								<a href="#">See all notifications <i class="m-icon-swapright"></i></a>							</li>
						</ul>
					</li>
					...
					<li class="dropdown" id="header_inbox_bar">
						...
						<ul class="dropdown-menu extended inbox">
							...
							<li>
								...
								<span class="time">16 mins</span>								</span>
								<span class="message">
							...
							<li>
								...
								auctor nibh...								</span>								</a>							</li>
							<li class="external">
								<a href="#">See all messages <i class="m-icon-swapright"></i></a>							</li>
						</ul>
					</li>
					<!-- END INBOX DROPDOWN -->
					<!-- BEGIN TODO DROPDOWN -->
					<li class="dropdown" id="header_task_bar">
						...
						<ul class="dropdown-menu extended tasks">
							...
							<li>
								...
								<span style="width: 30%;" class="bar"></span>								</span>								</a>							</li>
							<li>
								<a href="#">
								<span class="task">
							...
							<li>
								...
								<span class="progress progress-success">
								<span style="width: 98%;" class="bar"></span>								</span>								</a>							</li>
							<li>
								<a href="#">
								<span class="task">
							...
							<li>
								...
								<span style="width: 58%;" class="bar"></span>								</span>								</a>							</li>
							<li>
								<a href="#">
								<span class="task">
								...
								<span class="progress progress-success">
								<span style="width: 85%;" class="bar"></span>								</span>								</a>							</li>
							<li class="external">
								<a href="#">See all tasks <i class="m-icon-swapright"></i></a>							</li>
						</ul>
					</li>
					<!-- END TODO DROPDOWN -->
		...
		<div class="page-sidebar nav-collapse collapse">
			...
			<ul>
				...
				<li class="">
					...
					<span class="title">Visual Charts</span>					</a>				</li>
				<li class="">
				...
				<li class="">
					<a href="login.html">
					<i class="icon-user"></i> 
					<span class="title">Login Page</span>					</a>				</li>
			</ul>
			<!-- END SIDEBAR MENU -->
		</div>
		<!-- END SIDEBAR -->
								...
								<div class="portlet-title">
									...
									<div class="tools">
										<div class="btn-group pull-right" data-toggle="buttons-radio">
											...
											<a href="javascript:;" class="btn mini active">Feedbacks</a>										</div>
									</div>
								</div>
								...
								<div class="portlet-title">
									...
									<div class="tools">
										<div class="btn-group pull-right" data-toggle="buttons-radio">
											...
											<a href="javascript:;" class="btn blue mini">Orders</a>										</div>
									</div>
								</div>
								<div class="portlet-body">
								...
								<div class="portlet-title">
									...
									<div class="tools">
										<div class="btn-group pull-right" data-toggle="buttons-radio">
											...
											<a href="javascript:;" class="btn red mini">Web</a>										</div>
									</div>
								</div>
								<div class="portlet-body">
									...
									<div id="region_statistics_content" class="hide">
										<div class="btn-toolbar">
											<div class="btn-group " data-toggle="buttons-radio">
												...
												<a href="javascript:;" class="btn mini">Orders</a>											</div>
											<div class="btn-group pull-right">
												<a href="javascript:;" class="btn mini dropdown-toggle" data-toggle="dropdown">
												Select Region <span class="icon-angle-down"></span>												</a>
												<ul class="dropdown-menu">
							...
							<div class="portlet">
								...
								<div class="portlet-body" id="chats">
									...
									<div class="chat-form">
										...
										<div class="btn-cont"> 
											<span class="arrow"></span>
											<a href="javascript:;" class="btn blue icn-only"><i class="icon-ok icon-white"></i></a>										</div>
									</div>
								</div>
							</div>
							<!-- END PORTLET-->
	...
	<script src="<?php echo HTTP_ASSETS_PATH_ADMIN?>jquery-ui/jquery-ui-1.10.1.custom.min.js"></script>	
	<script src="<?php echo HTTP_ASSETS_PATH_ADMIN?>jquery-slimscroll/jquery.slimscroll.min.js"></script>
	<script src="<?php echo HTTP_ASSETS_PATH_ADMIN?>fullcalendar/fullcalendar/fullcalendar.min.js"></script>
	...
	<script src="<?php echo HTTP_ASSETS_PATH_ADMIN?>jqvmap/jqvmap/jquery.vmap.js" type="text/javascript"></script>	
	<script src="<?php echo HTTP_ASSETS_PATH_ADMIN?>jqvmap/jqvmap/maps/jquery.vmap.russia.js" type="text/javascript"></script>
	<script src="<?php echo HTTP_ASSETS_PATH_ADMIN?>jqvmap/jqvmap/maps/jquery.vmap.world.js" type="text/javascript"></script>
	<script src="<?php echo HTTP_ASSETS_PATH_ADMIN?>jqvmap/jqvmap/maps/jquery.vmap.europe.js" type="text/javascript"></script>
	<script src="<?php echo HTTP_ASSETS_PATH_ADMIN?>jqvmap/jqvmap/maps/jquery.vmap.germany.js" type="text/javascript"></script>
	<script src="<?php echo HTTP_ASSETS_PATH_ADMIN?>jqvmap/jqvmap/maps/jquery.vmap.usa.js" type="text/javascript"></script>
	<script src="<?php echo HTTP_ASSETS_PATH_ADMIN?>jqvmap/jqvmap/data/jquery.vmap.sampledata.js" type="text/javascript"></script>	
	<script src="<?php echo HTTP_ASSETS_PATH_ADMIN?>flot/jquery.flot.js"></script>
	<script src="<?php echo HTTP_ASSETS_PATH_ADMIN?>flot/jquery.flot.resize.js"></script>
	<script type="text/javascript" src="<?php echo HTTP_ASSETS_PATH_ADMIN?>gritter/js/jquery.gritter.js"></script>
	<script type="text/javascript" src="<?php echo HTTP_ASSETS_PATH_ADMIN?>uniform/jquery.uniform.min.js"></script>	
	<script type="text/javascript" src="<?php echo HTTP_ASSETS_PATH_ADMIN?>js/jquery.pulsate.min.js"></script>
