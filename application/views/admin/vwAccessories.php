				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="#">Manage Accessories</a></li>
						</ul>
					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							<div class="portlet-title">
								<h4><i class="icon-globe"></i>Manage Accessories</h4>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">
										<a class="btn green" data-toggle="modal" href="#popup" onclick="add()">
...
<td class="hidden-480"><a class="btn mini green" data-toggle="modal" href="#popup" onclick="edit('<?php echo $val->sub_subcategory_id;?>')"><i class="icon-edit"></i> Edit</a></td>
	...
	function edit(id)
	{
		...
		$.post('<?php echo base_url();?>admin/accessory/editSubSubCategory',{ id : id },
			function(data)
			{
	...
	function add()
	{
		...
		$.post('<?php echo base_url();?>admin/accessory/addSubSubCategory',
			function(data)
			{
	...
	{	
		...
		if(cnf)
		{
			...
			$.post('<?php echo base_url();?>admin/accessory/deleteAccessory',{ accessory_id : id,mode : 'single' },
				function(data)
				{
					$('#tablesec').html(data);
	...
	{
		var cat = document.getElementsByName('accessory[]');
		...
		if(str != "")
		{
			...
			if(cnf)
			{
				...
				$.post('<?php echo base_url();?>admin/accessory/deleteAccessory',{ accessory_id : str , mode : 'selected' },
					function(data)
					{
						$('#tablesec').html(data);
	...
	function changestatus(stat,id)
	{
		...
		$.post("<?php echo base_url()?>admin/accessory/changeStatus",{'stat':stat,'id':id});
	}
	</script>
