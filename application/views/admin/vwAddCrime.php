               ...
               <div class="span12">
                  ...
                  <div class="portlet box blue">
                     ...
                     <div class="portlet-body form">
						...
						<form name="frmpage" class="form-horizontal" action="<?php echo base_url()?>admin/crimes/updateCrime/add" method="post" style="margin:0; padding:0" enctype="multipart/form-data">
